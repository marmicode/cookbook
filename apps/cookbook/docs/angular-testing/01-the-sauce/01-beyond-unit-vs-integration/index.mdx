...
- They are more [symmetric to production](/angular/testing/glossary#symmetric-to-production), and [predictive](/angular/testing/glossary#predictive), thus more reassuring.
- They are more [structure-insensitive](/angular/testing/glossary#structure-insensitive) _(e.g. you can refactor your code without breaking them)_.
...
| **[Precision](/angular/testing/glossary#precise-tests)**                     | Higher Precision      | Lower Precision       |
| **[Production-Symmetry](/angular/testing/glossary#symmetric-to-production)** | Lower Symmetry        | Higher Symmetry       |
| **[Structure-Sensitivity](/angular/testing/glossary#structure-insensitive)** | Higher Sensitivity    | Lower Sensitivity     |
...
On the other hand, Over-Narrow tests can lead to [over-specification](/angular/testing/glossary#over-specification) and make tests more [structure-sensitive](/angular/testing/glossary#structure-insensitive) and brittle.
:::
...
Cf. [Designing a Pragmatic Testing Strategy](/angular/testing/pragmatic-testing-strategy)
