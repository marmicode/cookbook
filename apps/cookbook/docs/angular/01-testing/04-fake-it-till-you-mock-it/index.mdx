...
<ImageContainer size="large">
  [![Deep Dive into Test
  Doubles](./fake-it-till-you-mock-it-course-module.jpg)](https://courses.marmicode.io/courses/pragmatic-angular-testing)
</ImageContainer>

<center>
  [**👉 Enroll Now
  👈**](https://courses.marmicode.io/courses/pragmatic-angular-testing)
</center>
