...
- 🫤 or **losing Nx builtin plugins inference**.
...
- 💻 Implicit Libs Plugin Example: https://github.com/marmicode/cookbook-demos/tree/nx-implicit-libs/tools/plugins/implicit-libs.ts
