...
A common drawback when creating libraries is the boilerplate. Even though they are generally generated and taken care of by Nx _(using [generators](/nx/glossary#generators) and [migrations](/nx/glossary#migration))_, it can clutter the workspace and add some cognitive load.
