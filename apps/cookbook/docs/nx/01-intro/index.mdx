...
- Should we use Nx?
- Should we use a single repository _(monorepo)_ or multiple repositories _(polyrepo)_?
- Should we split our code into apps and libraries?
- If so, how should we organize them?
